...
public class CreateAutomatonPanel extends JPanel {
     ...
     * @return true si es inválido, false en caso contrario.
     */
     ...
     * @param finals Lista de estados finales.
     */
     ...
     * @return Índice de la columna, o -1.
     */
